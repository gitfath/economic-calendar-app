...
# ============================================================
# 1. Chargement du fichier .env depuis le dossier du script (si dotenv installé)
try:
...
# 2. Lecture des variables depuis os.getenv (après chargement du .env)
...
# 3. Surcharge avec st.secrets si l'application tourne sur Streamlit Cloud
try:
...
# 4. Diagnostic (sans exposer les secrets entièrement)
print("\n🔍 DIAGNOSTIC DES VARIABLES :")
print(f"   PARSEBOT_API_KEY : {'OK' if PARSEBOT_API_KEY else 'MANQUANTE'}")
print(f"   FRED_API_KEY     : {'OK' if FRED_API_KEY else 'MANQUANTE'}")
...
# 5. Vérification critique (arrêt si tokens manquants)
if TELEGRAM_BOT_TOKEN == "VOTRE_TOKEN" or TELEGRAM_CHAT_ID == "VOTRE_CHAT_ID":
    print("❌ ERREUR : Tokens Telegram non configurés !")
    print("   - En local : vérifiez que le fichier .env est dans le même dossier que app.py")
    print("   - Sur Streamlit Cloud : vérifiez les secrets dans l'interface")
    print("   - Contenu attendu du .env :")
...
# ============================================================
# RÉCUPÉRATION DES ÉVÉNEMENTS (Parse.bot + fallback ForexFactory)
# ============================================================
...
# ============================================================
# IMPACT DIRECTIONNEL SUR LE DOLLAR
# ============================================================
